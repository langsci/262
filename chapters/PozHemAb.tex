...
if we consider traceless theories of extraction, with a SLASH feature
...
& Inside another constituent \\
 ...
 \caption{Annotation for object relatives in the corpus}
 \label{tab:1:annotation}
\end{table}


\subsection{Results}
To analyze the corpus data, we ran logistic regression models using
the glmer function in the lme4 R package from \citet{Bates2015}. The
...
\begin{figure}
\subfigure[Relative Length]{\includegraphics[width = .48\linewidth]{chapters/pozhemab1.pdf}} 
\subfigure[Intentional Subject]{\includegraphics[width = .48\linewidth]{chapters/pozhemab2.pdf}}\\
\subfigure[Subject and Verb Length]{\includegraphics[width = .48\linewidth]{chapters/pozhemab3.pdf}}
\subfigure[Object Definiteness]{\includegraphics[width = .48\linewidth]{chapters/pozhemab4.pdf}}\\
...
\begin{figure}
\subfigure[Verb Agentivity (Ag ±)]{\includegraphics[width = 2.4in]{chapters/PozHemAb31.pdf}}
\subfigure[Subject Length (Long ±)]{\includegraphics[width = 2.4in]{chapters/PozHemAb32.pdf}}
\subfigure[Subject Inversion (Inv ±)]{\includegraphics[width = 2.4in]{chapters/PozHemAb33.pdf}}
...
\begin{figure}[H]
  \resizebox{\linewidth}{!}{\includegraphics{chapters/PozHemAb4.pdf}}
...
\begin{figure}[H]
    \resizebox{\linewidth}{!}{\includegraphics{chapters/PozHemAb5.pdf}}
